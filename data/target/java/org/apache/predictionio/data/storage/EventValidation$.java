...
public  class EventValidation$ {
  ...
  public   EventValidation$ () { throw new RuntimeException(); }
  /** Default time zone is set to UTC */
  public  org.joda.time.DateTimeZone defaultTimeZone () { throw new RuntimeException(); }
  /** Checks whether an event name contains a reserved prefix
   * <p>
   * @param name Event name
   * @return true if event name starts with \$ or pio_, false otherwise
   */
  public  boolean isReservedPrefix (java.lang.String name) { throw new RuntimeException(); }
  /** PredictionIO reserves some single entity event names. They are currently
   * \$set, \$unset, and \$delete.
   */
  public  scala.collection.immutable.Set<java.lang.String> specialEvents () { throw new RuntimeException(); }
   ...
   */
  public  boolean isSpecialEvents (java.lang.String name) { throw new RuntimeException(); }
   ...
   */
  public  void validate (org.apache.predictionio.data.storage.Event e) { throw new RuntimeException(); }
  /** Defines built-in entity types. The current built-in type is pio_pr. */
  public  scala.collection.immutable.Set<java.lang.String> builtinEntityTypes () { throw new RuntimeException(); }
  /** Defines built-in properties. This is currently empty. */
  public  scala.collection.immutable.Set<java.lang.String> builtinProperties () { throw new RuntimeException(); }
  /** Checks whether an entity type is a built-in entity type */
  public  boolean isBuiltinEntityTypes (java.lang.String name) { throw new RuntimeException(); }
   ...
   * @param e Event to be validated
   */
  public  void validateProperties (org.apache.predictionio.data.storage.Event e) { throw new RuntimeException(); }
}
