...
public  class CassandraLEvents implements org.apache.predictionio.data.storage.LEvents, grizzled.slf4j.Logging {
  ...
  // not preceding
  public   CassandraLEvents (org.apache.predictionio.data.storage.cassandra.CassandraClient client, org.apache.predictionio.data.storage.StorageClientConfig config, java.lang.String namespace) { throw new RuntimeException(); }
  ...
  public  org.apache.predictionio.data.storage.Event resultToEvent (com.datastax.driver.core.Row row, int appId) { throw new RuntimeException(); }
