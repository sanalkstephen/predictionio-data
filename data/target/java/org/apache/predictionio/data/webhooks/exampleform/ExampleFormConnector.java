...
public  class ExampleFormConnector implements org.apache.predictionio.data.webhooks.FormConnector {
  static public  org.json4s.JsonAST.JObject toEventJson (scala.collection.immutable.Map<java.lang.String, java.lang.String> data) { throw new RuntimeException(); }
  static public  org.json4s.JsonAST.JObject userActionToEventJson (scala.collection.immutable.Map<java.lang.String, java.lang.String> data) { throw new RuntimeException(); }
  static public  org.json4s.JsonAST.JObject userActionItemToEventJson (scala.collection.immutable.Map<java.lang.String, java.lang.String> data) { throw new RuntimeException(); }
}
